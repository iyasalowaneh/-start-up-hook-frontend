  ...
  return (
    <HomeDiv>
      ...
      <P>
        ...
        our story starts when we found out how much the start-ups face issues in
        funding ,consultation and the huge gap between a start-up and investor.
        so we came up with this great idea to make that gap smaller and git you
        the right consultation. all you have to do is post your idea in our
        website and we will take care about it. also, we thought about the
        investor who is tired of looking for a great idea, idea allows him to
        expand and improves his business. we also give the chance to anyone to
        make a donation to help our beloved youth in our belover arab world.
      </P>
      <H2>Success Story </H2>
      <P>Some of the fully funded ideas. yours will be the next one.</P>
